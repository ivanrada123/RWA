...
<head>
    ...
    <title>Add models Form - Laravel 9 CRUD</title>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="models name">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>manufacturer id:</strong>
                        <input type="integer" name="manufacturer_id" class="form-control" placeholder="manufacturer id">
                    </div>
                </div>
