...
<head>
    ...
    <title>Add parts Form - Laravel 9 CRUD</title>
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('parts.index') }}"> Back</a>
                </div>
            </div>
        </div>
        @if(session('status'))
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="part name">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>part price:</strong>
                        <input type="integer" name="price" class="form-control" placeholder="part price">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>part quantity:</strong>
                        <input type="integer" name="quantity" class="form-control" placeholder="part quantity">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>models id:</strong>
                        <input type="integer" name="model_id" class="form-control" placeholder="models id">
                    </div>
                </div>
