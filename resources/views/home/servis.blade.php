		...
		<div class="container">
			...
			<section class="paragraph">
				<h1>Heading 1 With Paragraph</h1>
					<p>Lorem Ipsum available, but the majority have suffered This alteration in some from, by injected is a humour, or</p>
			</section>
			...
			<section class="unordered-list">
				<h1>Unordered List</h1>
					<p>Lorem Ipsum available, but the majority have suffered This alteration in some form, by injected<br><br> i If  to use and yammi passag.</p>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
			...
			<section class="image-text">
				<div class="container">						
					<div class="row">
						...
						<div class="col-md-8">
							<p class="image-text-text">Lorem Ipsum available, but the majority have suffered <br><br>
							Lorem Ipsum available, but the majority have suffered This alteration in some form</p>	
						</div>
					</div>												
					<div class="row">
						...
						<div class="col-md-8 col-md-pull-4">
							<p class="image-text-text">Lorem Ipsum available, but the majority have suffered<br><br>
							Lorem Ipsum available, but the majority hav</p>	
						</div>
					</div>						
				</div>
			</section>				
		...
		<section class="social-contact-icon">
			...
			<form action="{{url('/dodaj_mobitel')}}" method= "post">
				@csrf
				<input type="text" name="model" placeholder="Ne kucaj ako nije iPhone">
				<input type="text" name="proizvodjac" placeholder="Ne kucaj ako nije Apple">
				<input type="text" name="ocuvanost" placeholder="Ne kucaj ako nije ko nov">
